"""
Django settings for boryaonelove project.
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'boryaonelove.settings'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.10/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '%pe)gf1b9&uz1^+lc&n&2epr9kp+rdu3okn_xkgtp5@elwv)=a'
...
ROOT_URLCONF = 'boryaonelove.urls'
...
WSGI_APPLICATION = 'boryaonelove.wsgi.application'
...
CODEMIRROR_PATH = "/home/user1/bakawok/boryaonelove/firstwin/static/codemirror/"
